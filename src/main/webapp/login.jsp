...
<head>
    ...
    <title>CityCab</title><!--begin::Primary Meta Tags-->
...
<div class="login-box">
    <div class="login-logo"> <a href=""><b>CityCab</b></a> </div> <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="login" method="post">
                <div class="input-group mb-3"> <input value="${not empty username ? username : ''}"  type="text" class="form-control" name="username" placeholder="User Name">
                    <div class="input-group-text"> <span class="bi bi-person-fill"></span> </div>
                </div>
                <div class="input-group mb-3"> <input value="${not empty password ? password : ''}"  type="password" class="form-control" name="password" placeholder="Password">
